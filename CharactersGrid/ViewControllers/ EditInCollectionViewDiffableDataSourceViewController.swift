//
//   EditInCollectionViewDiffableDataSourceViewController.swift
//  CharactersGrid
//
...
class EditInCollectionViewDiffableDataSourceViewController: UIViewController {
...
struct EditInCollectionViewDiffableDataSourceViewControllerRepresentable: UIViewControllerRepresentable {
    
    let sectionedCharacters: [SectionCharactersTuple]
    
    func makeUIViewController(context: Context) -> some UIViewController {
        UINavigationController(rootViewController: EditInCollectionViewDiffableDataSourceViewController(sectionedCharacters: sectionedCharacters))
    }
...
struct EditInCollectionViewDiffableDataSourceViewController_Previews: PreviewProvider {
    
    static var previews: some View {
        EditInCollectionViewDiffableDataSourceViewControllerRepresentable(sectionedCharacters: Universe.ff7r.sectionedStubsTuple)
